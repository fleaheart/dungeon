(function () {
    function addEvent(c, a, b) { if (c.addEventListener) {
    ...
    function e(a) { var b = (typeof a == "string") ? document.getElementById(a) : a; if (b == null) {
        return;
    } if (!b.getText) {
        b.getText = function () { return b.value || b.textContent || b.innerText; };
    } if (!b.setText) {
        b.setText = function (c) { if (b.value != null) {
            b.value = c;
        }
        else {
